...
enum ParseChar
{
   ...
   NEWLINE_KEY      = int('\n'),  // enter('\n') or ctrl-m
   ESC_KEY          = 27,         // Not printable; used for combo key
 ...
 //HOME_KEY         = 49 + MOD_KEY_FLAG,
   HOME_KEY         = 54 , //Set Home at fn+6
   INSERT_KEY       = 50 + MOD_KEY_FLAG,
 //DELETE_KEY       = 51 + MOD_KEY_FLAG,
   DELETE_KEY       = 48,  //Set Delete at fn+0
 //END_KEY          = 52 + MOD_KEY_FLAG,
   END_KEY          = 55,  //Set End at fn+7   
 //PG_UP_KEY        = 53 + MOD_KEY_FLAG,
   PG_UP_KEY        = 56, //Set PgUP at fn+8
 //PG_DOWN_KEY      = 54 + MOD_KEY_FLAG,
   PG_DOWN_KEY      = 57,   //Set PgDown at fn +9
